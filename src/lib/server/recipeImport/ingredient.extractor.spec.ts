...
describe('extractIngredients', () => {
    ...
    it('should extract Ingredients froms Lines where unit is at the end', () => {
        const input = ['Lachsfilet, tiefgefroren 600g', 'Brokkoli 2 St.', 'Kartoffeln 500g'];
        const expected = [{ name: 'Lachsfilet, tiefgefroren', amount: 600, unit: 'g' }, { name: 'Brokkoli', amount: 2, unit: 'St.' }, { name: 'Kartoffeln', amount: 500, unit: 'g' }];

<div class="card bg-base-200 shadow-xl p-8">
	...
	<ul class="index list-decimal">
		...
		<li>
			<a class="font-bold underline text-white hover:text-primary" href="#m3"
				>Kontakt Datenschutzbeauftragter, Verantwortlicher</a
			>
		</li>
		<li>
		...
		<li>
			<a class="font-bold underline text-white hover:text-primary" href="#m12">Löschung von Daten</a
			>
		</li>
		<li>
	...
	<div class="grid grid-cols-fluid">
		<div>
			<p class="text-justify">Friedrich, Fabian<br />Gartenfelder Str. 63<br />13599 Berlin</p>

			<p class="text-justify">
				E-Mail-Adresse: <a
					class="font-bold underline text-white hover:text-primary"
					href="mailto:friedrich.fabian@gmx.net">friedrich.fabian@gmx.net</a
				>
			</p>
		</div>

		<p class="text-justify">
			Impressum:<br />Friedrich, Fabian<br />Gartenfelder Str. 63<br />13599 Berlin
		</p>
	</div>
	...
	<p class="text-justify">
		...
		<a
			...
			target="_new">https://optout.aboutads.info</a
		>
		und
		<a
			class="font-bold underline text-white hover:text-primary"
	...
	<ul class="list-disc">
		<li>
			<strong>Verarbeitete Datenarten:</strong> Bestandsdaten (z. B. Namen, Adressen); Kontaktdaten (z. B.
			E-Mail, Telefonnummern); Nutzungsdaten (z. B. besuchte Webseiten, Interesse an Inhalten, Zugriffszeiten);
			Meta-, Kommunikations- und Verfahrensdaten (z. B. IP-Adressen, Zeitangaben, Identifikationsnummern,
			Einwilligungsstatus); Event-Daten (Facebook) ("Event-Daten" sind Daten, die z. B. via Facebook-Pixel
			(via Apps oder auf anderen Wegen) von uns an Facebook übermittelt werden können und sich auf Personen
			oder deren Handlungen beziehen; Zu den Daten gehören z. B. Angaben über Besuche auf Websites, Interaktionen
			mit Inhalten, Funktionen, Installationen von Apps, Käufe von Produkten, etc.; die Event-Daten werden
			zwecks Bildung von Zielgruppen für Inhalte und Werbeinformationen (Custom Audiences) verarbeitet;
			Event Daten beinhalten nicht die eigentlichen Inhalte (wie z. .B. verfasste Kommentare), keine
			Login-Informationen und keine Kontaktinformationen (also keine Namen, E-Mail-Adressen und Telefonnummern).
			Event Daten werden durch Facebook nach maximal zwei Jahren gelöscht, die aus ihnen gebildeten Zielgruppen
	...
	<ul class="list-disc">
		<li>
			...
			<a
				...
				target="_blank">https://www.apple.com/de/</a
			>.
		...
		<li>
			...
			<a
				...
				target="_blank">https://www.google.de</a
			>;
			<strong>Datenschutzerklärung:</strong>
			<a
				class="font-bold underline text-white hover:text-primary"
	...
	<ul class="list-disc">
		<li>
			...
			besuchte Webseiten, Interesse an Inhalten, Zugriffszeiten); Meta-, Kommunikations- und Verfahrensdaten
	...
	<ul class="list-disc">
		<li>
			...
			daher an der Identität des Verfassers interessiert.<br /><br />Des Weiteren behalten wir uns
			vor, auf Grundlage unserer berechtigten Interessen die Angaben der Nutzer zwecks Spamerkennung
			zu verarbeiten.<br /><br />Auf derselben Rechtsgrundlage behalten wir uns vor, im Fall von
			Umfragen die IP-Adressen der Nutzer für deren Dauer zu speichern und Cookies zu verwenden, um
			Mehrfachabstimmungen zu vermeiden.<br /><br />Die im Rahmen der Kommentare und Beiträge
			mitgeteilten Informationen zur Person, etwaige Kontakt- sowie Webseiteninformationen als auch
			die inhaltlichen Angaben werden von uns bis zum Widerspruch der Nutzer dauerhaft gespeichert;<br
			/><span class=""
	...
	<ul class="list-disc">
		<li>
			<strong>Google Analytics 4: </strong>Wir verwenden Google Analytics zur Messung und Analyse
			der Nutzung unseres Onlineangebotes auf der Grundlage einer pseudonymen
			Nutzeridentifikationsnummer. Diese Identifikationsnummer enthält keine eindeutigen Daten, wie
			Namen oder E-Mail-Adressen. Sie dient dazu, Analyseinformationen einem Endgerät zuzuordnen, um
			zu erkennen, welche Inhalte die Nutzer innerhalb eines oder verschiedener Nutzungsvorgänge
			...
			werden können. Google Analytics protokolliert und speichert keine individuellen IP-Adressen
			für EU-Nutzer. Analytics stellt jedoch grobe geografische Standortdaten bereit, indem es die
			folgenden Metadaten von IP-Adressen ableitet: Stadt (und der abgeleitete Breiten- und
			Längengrad der Stadt), Kontinent, Land, Region, Subkontinent (und ID-basierte Gegenstücke).
			...
			protokolliert, sind nicht zugänglich und werden nicht für weitere Verwendungszwecke genutzt.
			Wenn Google Analytics Messdaten sammelt, werden alle IP-Abfragen auf EU-basierten Servern
		...
		<li>
			<strong>Google Tag Manager: </strong>Google Tag Manager ist eine Lösung, mit der wir sog.
			Website-Tags über eine Oberfläche verwalten und so andere Dienste in unser Onlineangebot
			einbinden können (hierzu wird auf weitere Angaben in dieser Datenschutzerklärung verwiesen).
			Mit dem Tag Manager selbst (welches die Tags implementiert) werden daher z. B. noch keine
			Profile der Nutzer erstellt oder Cookies gespeichert. Google erfährt lediglich die IP-Adresse
			des Nutzers, was notwendig ist, um den Google Tag Manager auszuführen;
			<strong>Dienstanbieter:</strong>
			Google Ireland Limited, Gordon House, Barrow Street, Dublin 4, Irland;
			<span class=""
	...
	<ul class="list-disc">
		...
		<li>
			...
			von Cookies); Marketing. Profile mit nutzerbezogenen Informationen (Erstellen von Nutzerprofilen).
		</li>
		<li><strong>Sicherheitsmaßnahmen:</strong> IP-Masking (Pseudonymisierung der IP-Adresse).</li>
		<li class="">
			<strong>Rechtsgrundlagen:</strong> Einwilligung (Art. 6 Abs. 1 S. 1 lit. a) DSGVO).
		...
		<li>
			...
			angeboten werden: <br /><br />a) Europa:
			<a
				class="font-bold underline text-white hover:text-primary"
	...
	<ul class="list-disc">
		<li>
			<strong>Google Adsense mit personalisierten Anzeigen: </strong>Wir nutzen den Dienst Google
			Adsense mit personalisierten Anzeigen, mit dessen Hilfe innerhalb unseres Onlineangebotes
			Anzeigen eingeblendet werden und wir für deren Einblendung oder sonstige Nutzung eine
			Entlohnung erhalten; <strong>Dienstanbieter:</strong> Google Ireland Limited, Gordon House,
		...
		<li>
			<strong>Google Adsense mit nicht-personalisierten Anzeigen: </strong>Wir nutzen den Dienst
			Google Adsense mit nicht-personalisierten Anzeigen, mit dessen Hilfe innerhalb unseres
			Onlineangebotes Anzeigen eingeblendet werden und wir für deren Einblendung oder sonstige
			Nutzung eine Entlohnung erhalten; <strong>Dienstanbieter:</strong> Google Ireland Limited,
